...
\begin{titlepage}
	\makeatletter
	%是否有校外指导老师，有的话就运行12行，否则运行15行，下面42行处的判断同理
	...
	\begin{center}
		...
		}
		{
			...
			% 生成校外毕设封面字段
			\begin{spacing}{1.8}
				\hspace{19.4mm}\songti\zihao{3}\selectfont{学\hspace{11mm}院：\dunderline[-10pt]{1pt}{\makebox[77.4mm][c]{\deptName}}}
				
				\hspace{19.4mm}\songti\zihao{3}\selectfont{专\hspace{11mm}业：\dunderline[-10pt]{1pt}{\makebox[77.4mm][c]{\major}}}
				
				\hspace{19.4mm}\songti\zihao{3}\selectfont{学生姓名：\dunderline[-10pt]{1pt}{\makebox[77.4mm][c]{\studentname}}}
				
				\hspace{19.4mm}\songti\zihao{3}\selectfont{学\hspace{11mm}号：\dunderline[-10pt]{1pt}{\makebox[77.4mm][c]{\studentid}}}
